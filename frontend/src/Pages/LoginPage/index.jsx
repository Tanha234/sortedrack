...
useEffect(() => {
  if (userToken) {
    ...
    localStorage.setItem('userDetails', JSON.stringify(userDetails)); // Save the user details to localStorage

    // Redirect based on the user's role
    if (role === 'superadmin'||role==='admin') {
      navigate('/stock', { replace: true });
    } else {
      // Default redirection for 'user' role and any other roles not specifically handled
      navigate('/common', { replace: true });
    }
  }
}, [userToken, navigate]); // Add navigate to the dependencies array
